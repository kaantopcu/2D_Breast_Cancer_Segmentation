...
def sample_image_metrics(groundtruth_mask, pred_mask): 
    print("Sample Image Precision: ", precision_score_(groundtruth_mask, pred_mask))
    print("Sample Image Recall: ", recall_score_(groundtruth_mask, pred_mask))
    print("Sample Image Accuracy: ", accuracy(groundtruth_mask, pred_mask))
    print("Sample Image Dice Coefficient: ", dice_coef(groundtruth_mask, pred_mask))
    print("Sample Image Jaccard Index: ", iou(groundtruth_mask, pred_mask))
    print("Sample Image Hausdorff Distance: ", hausdorff_distance(groundtruth_mask, pred_mask))
    print("Sample Image Average Symmetric Surface Distance: ", average_symmetric_surface_distance(groundtruth_mask, pred_mask))
    print("Sample Image Volumetric Similarity: ", volumetric_similarity(groundtruth_mask, pred_mask))
    print("Sample Image Specificity (True Negative Rate): ", specificity(groundtruth_mask, pred_mask))
    print("Sample Image Matthews Correlation Coefficient: ", matthews_corrcoef(groundtruth_mask, pred_mask))
    print("Sample Image Normalized Surface Distance: ", normalized_surface_distance(groundtruth_mask, pred_mask))